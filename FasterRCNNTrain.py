...
if TrainMode:
  ...
  for i in range(epochs):
    ...
    torch.save(detector.state_dict(), "/home/hooshyarin/Documents/3D_Objec_Detection/model_weights/fusion_noTransformer/model"+str(i)+".pt")
...
for data in tqdm(dataloader_test):
  ...
  im2 = imgs[0]
  bevs = (torch.permute(bev, (0,3, 1, 2))).to(args.device, dtype=torch.float32)
  # calc the boxes for bev image 
  #draw_box3d_on_top(bev[0][1], targetBox[0] )
