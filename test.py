...
def draw_rect2d(img, prop_proj_1, classes_pred_1):
    ...
    cv2.imwrite('preTrainRect.jpg',img4) 
...
def main():
    ...
    detector.load_state_dict(torch.load("/home/hooshyarin/Desktop/model60.pt"))#/home/hooshyarin/Documents/3D_Objec_Detection/model_weights/model38.pt"))
    ...
    for data in tqdm(dataloader_test):
        ...
        draw_rect(img, targetBox, "MainImages", framelabels)
        im = img[0]
